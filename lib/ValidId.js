...
class NotInStoreId extends ValidId {
  absent (forceCheck = false) {
    if (forceCheck) throw this.buildError('param.cannot.be.absent.and.not.in.store')
    return super.absent(false)
  }
...
class NoCheckId extends ValidId {
  absent (forceCheck = false) {
    return ParamCheck.prototype.absent.call(this, forceCheck)
  }
