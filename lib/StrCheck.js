...
class StrCheck extends ParamCheck {
  ...
  predicate(f) {
    return new CheckStrDecorator(this.k, this, f)
  }
  parse(f) {
    return new ParseStrDecorator(this.k, this, f)
  }
  crypto(algo) {
...
class CheckStrDecorator extends StrCheck {
  constructor(k, d, f) {
    super(k)
    this.d = d
    this.f = f
...
class RegexDecorator extends CheckStrDecorator {
  constructor(k, d, rx) {
    super(k, d, s => rx.test(s))
  }
}

class ParseStrDecorator extends StrCheck {
  constructor(k, d, f) {
    super(k)
    this.d = d
    this.f = f
